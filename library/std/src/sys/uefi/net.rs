...
use crate::net::{Ipv4Addr, Ipv6Addr, Shutdown, SocketAddr, SocketAddrV6};
use crate::os::uefi;
use crate::os::uefi::raw::protocols::tcp6;
use crate::sys::unsupported;
use crate::time::Duration;

pub struct TcpStream {
    inner: uefi_tcp6::Tcp6Protocol,
}

impl TcpStream {
    fn new(inner: uefi_tcp6::Tcp6Protocol) -> Self {
        Self { inner }
    }
    ...
    pub fn bind(addr: io::Result<&SocketAddr>) -> io::Result<TcpListener> {
        ...
        match addr {
            SocketAddr::V4(x) => {
                ...
                let v6_socket =
                    SocketAddr::from(SocketAddrV6::new(x.ip().to_ipv6_mapped(), x.port(), 0, 0));
                TcpListener::bind(Ok(&v6_socket))
            }
            SocketAddr::V6(x) => {
...
//             let mut ip6_mode_data: MaybeUninit<ip4::ModeData> = MaybeUninit::uninit();
...
//                     use_default_address: Boolean::from(use_default_address),
...
//
//             let accept_event =
//                 uefi::thread::Event::create(0, uefi::raw::TPL_APPLICATION, None, None)?;
